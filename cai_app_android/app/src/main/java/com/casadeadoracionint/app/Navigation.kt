...
import com.casadeadoracionint.app.ui.BosquejosScreen
import com.casadeadoracionint.app.ui.CelugramaScreen
import com.casadeadoracionint.app.ui.AnunciosScreen
import com.casadeadoracionint.app.ui.RadioScreen
import com.casadeadoracionint.app.ui.HistorialCelugramasScreen
import com.casadeadoracionint.app.ui.AcercaDeScreen
import androidx.compose.material.icons.filled.MoreVert
import androidx.compose.material.icons.filled.Info
import androidx.compose.material.icons.filled.History
...
import com.casadeadoracionint.app.ui.MisDiscipulosScreen
import com.casadeadoracionint.app.ui.PerfilScreen
...
fun MainNavigation(isLoggedIn: Boolean, onLoginClick: () -> Unit, onLogoutClick: () -> Unit) {
    ...
    var notificacionesList by remember { mutableStateOf<List<com.casadeadoracionint.app.data.Notificacion>>(emptyList()) }
    ...
    LaunchedEffect(isLoggedIn) {
        if (isLoggedIn) {
            val currentUser = com.casadeadoracionint.app.data.Supabase.client.auth.currentUserOrNull()
            if (currentUser != null) {
                try {
                    val usuarioDB = com.casadeadoracionint.app.data.Supabase.client.from("usuarios")
                    ...
                    val notis = com.casadeadoracionint.app.data.Supabase.client.from("notificaciones")
                        .select {
                            filter {
                                eq("usuario_id", currentUser.id)
                            }
                        }.decodeList<com.casadeadoracionint.app.data.Notificacion>()
    ...
    if (showPerfil) {
        Scaffold(
            ...
            PerfilScreen(
                supabaseClient = com.casadeadoracionint.app.data.Supabase.client,
                            ...
                            DropdownMenu(
                                ...
                                DropdownMenuItem(
                                    ...
                                    onClick = {
                                        showMenu = false
                                        scope.launch {
                                            com.casadeadoracionint.app.data.Supabase.client.auth.signOut()
                                            onLogoutClick()
                                        }
                                    },
                    ...
                    onClick = {
                        ...
                        if (unreadIds.isNotEmpty()) {
                            ...
                            try {
                                ...
                                com.casadeadoracionint.app.data.Supabase.client.postgrest.from("notificaciones")
                                    .update(params) {
                                        filter {
                                            isIn("id", unreadIds)
                                        }
